<template>
  <div class="paper-card">
    ...
    <!-- Comments Row -->
    <el-row class="paper-comments-row" v-if="paper.comments">
      <el-col :span="24" class="paper-comments">
        <span><b>Comments:</b> {{ paper.comments }}</span>
      </el-col>
    </el-row>

    <!-- Subjects Row -->
    <el-row class="paper-subjects-row" v-if="paper.subjects">
      <el-col :span="24" class="paper-subjects">
        <span><b>Subjects:</b> {{ paper.subjects }}</span>
      </el-col>
    </el-row>
...
.paper-comments-row, .paper-subjects-row {
  margin-bottom: 4px;
}
.paper-comments, .paper-subjects {
  color: var(--text-color-secondary);
  font-size: calc(var(--font-size-small) - 2px);
  line-height: 1.5;
  padding: 2px var(--content-padding, 0);
